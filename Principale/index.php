...
<section class="hero bg-primary text-white text-center py-5">
    <div class="container">
        ...
        <p class="lead">Connectez-vous et explorez nos services pour une maison intelligent.</p>
    ...
    <div class="row">
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="<?= $row['url_image'] ?>" class="card-img-top" width="100" height="300" alt="<?= $row['nom'] ?>">
                    <div class="card-body">
